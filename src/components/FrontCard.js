...
const FrontCard = ({ placeholder, cardForm }) => {
  return(
      <div aria-hidden='true' className='card card-front'>
        ...
        <p data-testid='card-number' className='card-number'>
          { cardForm.number !== '' ? cardForm.number :  '0000 0000 0000 0000'}
        </p>
        <div className='card-bottom-section'>
          <p data-testid='card-name' className='card-holder-name'>
            { cardForm.name !== '' ? cardForm.name : placeholder.name }</p>
          <p data-testid='card-expiry-date' className='card-expiry-date'>
